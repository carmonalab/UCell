...
a <- plotUMAP(sce, colour_by = "NK", by_exprs_values = "UCell",
             point_size=0.2) + ggtitle("UCell")

b <- plotUMAP(sce, colour_by = "NK", by_exprs_values = "UCell_kNN",
             point_size=0.2) + ggtitle("Smoothed UCell")
